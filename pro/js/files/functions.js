$(function() {
  ...
  //===== Close Dynamic Dialog  =====//
	...
	//===== Open Dynamic Dialog  =====//
    $('.dialog_open_pro').click(function (e) {
    	
    	e.preventDefault();
    	var id = $(e.currentTarget).attr('id');
    	
        $('.dialog_pro'+id).dialog('open');
        return false;
    });
...
//------------------------------------------------------ 
    ...
    // Session Dialog Link
    $('.dialog_session').click(function (e) {
    	
    	e.preventDefault();
    	var btnVal = $(e.currentTarget).val();
    	$("#from_hidden_submit").val(btnVal);
...
//-----------------------------------------    
    ...
    $('.dialog_invitation').click(function (e) {

    	 $('.invitation_dialog').dialog('open');
        return false;
    });
//------------------------------------------------------	
	// Dialog
