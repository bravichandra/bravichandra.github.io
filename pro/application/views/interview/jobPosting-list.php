    ...
    <div class="main-wrapper">    	
        ...
        <div class="crmlite">        
            <div class="title-bar"> 
				...
				<a href="<?php echo base_url(); ?>interviewer/jobpost/edit" class="buttonM bBlack">Add New</a> 
            ...
            <table style='background: none repeat scroll 0 0 #E6E6E6; width:95%' class='tDefault dTable'>
                ...
                <tbody>
                	<?php foreach($jobpost as $jrow)    {
					?>
                    <tr>
						<td class='no-border'><input type="checkbox" value="<?php echo $jrow->post_id;?>" name="recids[]" class="rcselect" /></td>
                        <td class='no-border'><a href="<?php echo base_url(); ?>interviewer/jobpost/view/<?php echo $jrow->post_id;?>"><?php echo $jrow->job_title;?></a></td>
                        <td class='no-border'><?php echo $jrow->location;?></td>
                        <td class='no-border'><?php echo $jrow->playrate;?></td>
                        <td class='no-border'><?php echo ucfirst($jrow->usrname);?></td>
						<td class='no-border'><a href="<?php echo base_url(); ?>interviewer/jobpost/edit/<?php echo $jrow->post_id;?>">Edit</a></td>
