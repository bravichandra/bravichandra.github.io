<?php if($otasks_list){?><table style='margin: 6px 30px;width: 95%;background: none repeat scroll 0 0 #E6E6E6;' class='tDefault crmtab'>
    <thead>
		<tr>                        
            ...
            <th class='no-border' style="width:150px;">Subject</th>
            <th class='no-border' style="width:150px;">Record Owner</th>
            <th class='no-border' style="width:150px;">Due Date</th>
        </tr>
        <?php /*?><tr>                        
    ...
    <tbody>
        ...
        <tr>
            ...
            <?php /*?><td class='no-border'><?php echo date("m/d/Y",strtotime($crow->task_modified))?></td>
			<td class='no-border'><?php if((int)$crow->task_duedate)echo date("m/d/Y",strtotime($crow->task_duedate))?></td>
