...
<div id="content">
	...
	?>
	<!-- Main content -->
    <div class="main-wrapper applicantlite">    	
        <div class="formRow applicantlite" id="cLookup">
            <div class="qrbox">
        ...
        <?php if($er) {?>
        <div class="applicant-error"><?php echo implode("<br />",$er);?></div>
        <?php }?>
		<!-- Main content -->
            ...
            <tr>
            	<td colspan="4" align="center">
                    <div class="fluid" style="margin-top:15px;">
                        ...
                        <a href="<?php echo base_url();?>interviewer/<?php echo ($parent_id?$parent_section."/view/".$parent_id:'tasks');?>" class="buttonM bRed">Back</a>
                    </div>		
                </td>
            </tr>
        </table>
