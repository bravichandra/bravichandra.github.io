...
<div id="content">
    ...
    <div class="main-wrapper crmlite">
        <div class="crm-menu">
            <a href="<?php echo base_url();?>interviewer/<?php echo $parent_section;?>/view/<?php echo $parent_id?>" class="buttonM bBlack">Back</a>            
            <a href="<?php echo base_url();?>interviewer/tasks/edit/<?php echo $record[task_id]?>" class="buttonM bBlack">Edit</a> 
            <a href="<?php echo base_url();?>interviewer/tasks/delete/<?php echo $record[task_id]?>" onclick="if(!confirm('Are you sure you want to delete this tasks?')) return false;" class="buttonM bBlack">Delete</a>
        </div>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" style="width:95%;background: none repeat scroll 0 0 #f8f8f8;" align="center" class="contact-list view">
            <tbody>
                ...
                <tr>
                	<th class="one">Template Name</th><td class="two" class="4"><?php echo $record[task_name]?></td>
                </tr>
                <?php }?>
                <tr>
