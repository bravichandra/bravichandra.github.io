    ...
    <div class="formRow" id="NNNNNNNN">
        ...
        <form id="frm-qresp" action="<?php echo current_url();?>" method="post">
            ...
            <div class="qabox2">
                ...
                <?php /*?><div align="center" style="margin-top: 5px;margin-bottom: 5px;">
                    <a href="javascript:void(0);" class="buttonM bBlue" onclick="set_qranswer_id('QR1',15)">Your Answers</a>
                    <a href="javascript:void(0);" class="buttonM bGreen" onclick="set_qranswer_id('QR1',25)">Our Answers</a>
                </div><?php */?>
            </div><br clear="all" />
            ...
            <div class="qabox2">
                ...
                <?php /*?><div align="center" style="margin-top: 5px;margin-bottom: 5px;">
                    <a href="javascript:void(0);" class="buttonM bBlue" onclick="set_qranswer_id('QR2',14)">Your Answers</a>
                    <a href="javascript:void(0);" class="buttonM bGreen" onclick="set_qranswer_id('QR2',24)">Our Answers</a>
                </div><?php */?>
            </div><br clear="all" />
        ...
        <div id="AnsBlock11" style="display:none;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin:20px 0px !important;">
                    <tr>
                        ...
                        <td align="left">
                            <input type="hidden" name="squestions_title_id" value="<?php echo $tabtitles[0]->id;  ?>" class="qorder"/>
                            <input type="hidden" name='squestions_type' value="<?php echo $tabtitles[0]->qb_type;  ?>" />
                            <input type="text" class="cat_cus_title qorder" placeholder="Pre-Qualifying" value="<?php echo $tabtitles[0]->title;  ?>" name="squestions_title"/>
                        </td>
                    </tr>
            </table>           
                ...
                <h3 style="margin-top:30px;color: black;"><span style="color: #B30814;">Questions to Probe for Pain</span></h3>
                    ...
                    <div class="widget tableTabs">
                        <div class="tab_container">
                            <?php $i= 1;$q_cols_counts = 0;$q_cols = array(); ?>
                            <div id="ttab1" class="tab_content">
                                <table cellpadding="0" cellspacing="0" width="100%" class="tDefault" id="tq_table_<?php echo $i;?>">
                                    <tbody id="TechQualifyTbody">
                                    	<input type="hidden" name="camid" id="camid" value="<?php echo $active_campaign;  ?>" />
                                        <?php if($tech_qualify_pain) {$q_cols_counts += count($tech_qualify_pain);?>
                                            ...
                                            <tr class="QualifyBR_<?php echo $sintechpainQualify->tech_qualify_id ; ?> TechQualifyTrClass">
                                                ...
                                                <td class="no-border" style="width: 32%;">
                                                    <div class="grid5">                                                    
                                                        ...
                                                        <textarea  class="validate[required] gans<?php echo $sintechpainQualify->tech_qualify_id;?>"  style="width:500px;" id="QQ_7" name="tbl[tqd][<?php echo $sintechpainQualify->tech_qualify_id ?>][tech_qualify]" cols="" rows=""><?php echo $sintechpainQualify->tech_qualify_val ?></textarea>
                                                        <div  style="margin-top: 20px;">
                                                            ...
                                                            <div style="padding-top:10px;">                                                        	
                                                                <input type="checkbox" value="1" <?php if($sintechpainQualify->highlight) echo 'checked="checked"'; ?>  onchange="updateTechHighlightAnswer(<?php echo $sintechpainQualify->tech_qualify_id; ?>,this,0);" />
                                                                
                                                                Highlight answer in sales scripts
                                                            </div><br />
                                                            <div align="center"><a href="javascript:void(0);" class="buttonM bRed" onClick="show_qresponse(<?php echo $sintechpainQualify->tech_qualify_id;?>,0)">Add a Follow-Up Question</a></div>
                                                        </div>
                                                ...
                                                <tr class="TechQualifyTrClass">
                                                    ...
                                                    <td class="no-border" style="width: 32%;">
                                                        <div class="grid5"> 
                                                            ...
                                                            <div align="center"><a href="javascript:void(0);" class="buttonM bRed" onClick="show_qresponse(<?php echo $sintechpainQualifyOrp->tech_qualify_id;?>,0)">Add a Follow-Up Question</a></div>
                                                            </div>
                                                        </div>    
                                                    </td>
                                                    <td class="no-border" >
                                            ...
                                            <td class="no-border" style="width: 32%;">
                                                <div class="grid5">
                                                    ...
                                                    <div  style="margin-top: 20px;">
                                                      ...
                                                      <div><input type="checkbox" value="1" <?php if(!$q_cols[1]->visible) echo 'checked="checked"'; ?>  onchange="updateTechDisplay(<?php echo $q_cols[1]->tech_qualify_id; ?>,this,0);" /> Do not display answer in templates</div>
                                                      <div style="padding-top:10px;"><input type="checkbox" value="1" <?php if($q_cols[1]->highlight) echo 'checked="checked"'; ?>  onchange="updateTechHighlightAnswer(<?php echo $q_cols[1]->tech_qualify_id; ?>,this,0);" /> Highlight answer in sales scripts</div><br>
                                            ...
                                            <td class="no-border" style="width: 32%;">
                                                <div class="grid5">
                                                    ...
                                                    <div  style="margin-top: 20px;">
                                                      ...
                                                      <div><input type="checkbox" value="1" <?php if(!$q_cols[2]->visible) echo 'checked="checked"'; ?>  onchange="updateTechDisplay(<?php echo $q_cols[2]->tech_qualify_id; ?>,this,0);" /> Do not display answer in templates</div>
                                                      <div style="padding-top:10px;"><input type="checkbox" value="1" <?php if($q_cols[2]->highlight) echo 'checked="checked"'; ?>  onchange="updateTechHighlightAnswer(<?php echo $q_cols[2]->tech_qualify_id; ?>,this,0);" /> Highlight answer in sales scripts</div><br>
                    ...
                    <?php if($is_paid):?>
                    <div align="right">
                        <input type="button" <?php if($is_paid) { ?> onclick='DynamicAddRowTechQualify(this)'  
                        class="buttonM bBlack" <?php }else {?> id="33" data-icon="&#xe090;" class="dialog_open_pro buttonM bBlack" <?php }?>  value="Add a Question" style="margin-top:10px;color:white !important;"/>	        	
                    </div>
                    <?php else:?>
                    <div align="right">
                        <input type="button" id="33" data-icon="&#xe090;" class="dialog_open_pro buttonM bBlack show" 
                        value="Add a Question" style="margin-top:10px;color:white !important;"/>
                    </div>
                    <?php endif;?>
                   ...
                   <?php } ?>
                    ...
                    <div class="fluid" style="margin-top:-5px; float:left;">
                        <?php if($session_status != '2'):?>
                            ...
                            <?php if($tabtitles[0]->qb_type!='tab1'){  ?>
...
<script type="text/javascript">
	...
	function show_qresponse(qfid,qrparent) {
		...
		if($("#ansListh"+qfid).width()>400)$("#qresp").css("margin-left",($("#ansListh"+qfid).width()-400)+"px");
		$("#qresp #qid").val(qfid);
	...
	function DynamicAddRowTechQualify(obj)
	{
		...
		$.ajax({
			...
			data :  {'totalcount': numItems+1,'campaign':camid},
			success : function(data){
