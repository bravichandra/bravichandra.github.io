...
<script type="text/javascript">
	...
	function getLookup(rcname,obname) {
		...
		if(rcname=="account") {
			...
			popboxhead = 'Opportunity Lookup';
			ajxmethod='opportunities_lookup';
                            ...
                            <div class="box box_account_id" title="Account Name">
                            	<table cellpadding="0" cellspacing="0" border="0">
                                	<tr>
                                        ...
                                        <input type="text" readonly="readonly" value="<?php if(isset($record[account_title])) echo form_prep($record[account_title])?>" name="record[account_title]" id="account_id_title" />
                                        </td>
                                        <td><a href="javascript:void(0);" onclick="Records_getLookup('account','account_id');"><img border="0" src="<?php echo base_url('images/icons');?>/find.png" /></a>
                                        </td>
                                    </tr>    
                                </table>
                            </div>
                            
                            <div class="box box_contact_id" title="Contact Name">
                            	<table cellpadding="0" cellspacing="0" border="0">
                                	<tr>
                                        ...
                                        <input type="text" readonly="readonly" value="<?php if(isset($record[user_first])) echo form_prep($record[user_first]." ".$record[user_last])?>" name="record[contact_id]" id="contact_id_title" />
                                        </td>
                                        <td><a href="javascript:void(0);" onclick="Records_getLookup('contact','contact_id');"><img border="0" src="<?php echo base_url('images/icons');?>/find.png" /></a>
                                        </td>
                                    </tr>    
                                </table>
                            </div>
                            	...
                            	<table cellpadding="0" cellspacing="0" border="0">
                                	<tr>
                                        <th class="one">Lead Source</th><td class="two"><select name="record[lead_source]">
                                            ...
                                            <?php }  ?>
                                           <!-- <option value="Web"<?php if(isset($record[lead_source]) && $record[lead_source]=="Web") echo ' selected="selected"'?>>Web</option>
                                            <option value="Phone Inquiry"<?php if(isset($record[lead_source]) && $record[lead_source]=="Phone Inquiry") echo ' selected="selected"'?>>Phone Inquiry</option>
                                            <option value="Partner Referral"<?php if(isset($record[lead_source]) && $record[lead_source]=="Partner Referral") echo ' selected="selected"'?>>Partner Referral</option>
                                            <option value="Purchased List"<?php if(isset($record[lead_source]) && $record[lead_source]=="Purchased List") echo ' selected="selected"'?>>Purchased List</option>
                                            <option value="Other"<?php if(isset($record[lead_source]) && $record[lead_source]=="Other") echo ' selected="selected"'?>>Other</option>-->                
                                        </select></td>
                                    </tr>
                                </table>
                            </div>
