...
<div id="content">
    ...
    <div class="main-wrapper">        
        ...
        <div class="crmlite">
        	<div class="title-bar">            	                
                <a href="<?php echo base_url(); ?>crm/accounts/all" class="buttonM bBlack">All Accounts</a> 
                <a href="<?php echo base_url(); ?>crm/accounts/my" class="buttonM bBlack">My Accounts</a> 
                <a href="<?php echo base_url(); ?>crm/accounts" class="buttonM bBlack">Target Accounts</a> 
				<a href="<?php echo base_url(); ?>crm/accounts/edit" class="buttonM bBlack">Add New</a> 
                <a href="<?php echo base_url(); ?>crm/accounts/import" class="buttonM bBlack">Import</a> 
            ...
            <form method="post" action="<?php echo current_url();?>" id="frmlist">
                ...
                <div id="records_list"><?php include('accounts-ajax-list.php'); ?></div>           
        ...
        $("#morepages a").click(function(){
            ...
            $.ajax({
              ...
              url: $(this).attr("href")
                    ...
                    <?php /*?>oTaskTable.fnSort( [ [<?php echo (!isset($mine)?5:4)?>,'desc'] ] );<?php */?>
              })
              .fail(function() {
                $(".loader").html('');
