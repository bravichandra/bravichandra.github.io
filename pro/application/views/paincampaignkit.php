...
<div class="main-wrapper">
    ...
    <div class="wrapper">
        <div class="widget fluid">
            <div class="grid12">
                <div class="body">
                    <h1 class="pt10"><a href="<?php echo base_url(); ?>output/sales-letter-pain-focus"  target="_blank" title="Download" >Sales Letter &#45; Pain Focus</a></h1>
    ...
    <div class="wrapper">
        <div class="widget fluid">
            <div class="grid12">
                <div class="body">
                    <h1 class="pt10"><a <?php if ($is_paid) { ?>href="<?php echo base_url(); ?>output/pre-call-email-pain-focus" <?php } else { ?> id="32" data-icon="&#xe090;" class="dialog_open_pro fs1" <?php } ?> target="_blank" title="Download" >Pre&#45;Call Email &#45; Pain Focus</a><?php if(!$is_paid){ ?> <span style="font-size:.6em;vertical-align:top;"> (Only on Pro)</span> <?php } ?></h1>
