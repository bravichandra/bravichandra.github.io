					...
					<div class="fluid">
						<div class="grid6" style="width:initial;">
							<div class="widget" style="padding-right:20px;">
								<h1 style="margin-left:10px; margin-bottom:10px;" class="pt10">SalesScripter Set Up</h1>
                                <?php /*?><iframe width="560" height="315" src="https://www.youtube.com/embed/HT1DBIq1GWY?list=PLoUVJsDQgZII894paX8gfipNdgfKsBkmb" frameborder="0" allowfullscreen></iframe><?php */?>
								<iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLoUVJsDQgZII894paX8gfipNdgfKsBkmb" frameborder="0" allowfullscreen></iframe>
