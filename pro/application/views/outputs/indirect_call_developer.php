...
#content, table.output, table.output table {font-size:14px;font-weight: normal !important;line-height: 1.85px;}
...
<?php if(!$partid && $action!='download2') { ?>	
    ...
    <?php /*?><pre><?php print_r($parts);?></pre><?php */?>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>Hello  <span class="red-area">[Contact's Name]</span>, this is  <span><?php echo $company_meta['your_name'] ?></span> from  <span><?php echo  $company_info->company_name ; ?> </span>, have I caught you in the middle of anything?<br />
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>Great. The Purpose of my call is that &#45; <span class="red-area">(Choose one of below)</span>
				<ul>
					<li>We help  
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td class="td-pad-b">I actually don't know if you need what our services provide so I just had a question or two. 
			
				<p> <span class="red-area">-or- </span> </p>

				<p> I actually don’t know if you are a good fit for what we provide so I just had a question or two.</p>

				<p><span class="red-area"> -or- </span> </p>

				<p>I don’t know if you are the right person to speak with but I have just a couple of questions.</p>
    ...
    <?php if(!$partid && $action!='download2') { ?>
    <div align="center" style="margin-top:15px; font-size:12px; clear:both;">
        Helpful information can be found at <a href="http://www.salesscripter.com/library" target="_blank">www.salesscripter.com/library</a><br />
	...
	else if($partid == 1)
	{
	 ?>
        ...
        <p>Hello, I am trying to connect with <?php echo $campaign_info->individual; ?>. Can you point me in the right direction?</p>
        <br/>
        <h3 class="sub-dev-head-sub1">Prospect</h3>
        <p>Hello  <span class="red-area">[Contact's Name]</span>, this is  <span><?php echo $company_meta['your_name'] ?></span> from  <span><?php echo  $company_info->company_name ; ?> </span>, have I caught you in the middle of anything?</p>
	...
	else if($partid == 2)
	{
	 ?>
     	<h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
        <h3 class="sub-dev-head-sub1">Value Statement</h3>
        <p>Great. The Purpose of my call is that &#45; <span class="red-area">(Choose one of below)</span>
                ...
                <br/>
                <h2 class="sub-dev-head-sub1">Disqualify Statement</h2>
                <p>
        	...
        	<p>Great, if I could ask you real quick:</p>
				...
				<strong class="sub-dev-head-sub2">Technical Questions:</strong>
					...
					<strong class="sub-dev-head-sub2">Personal Questions:</strong>
						...
						<?php endif;?>
					<br/>
					<?php /*?><p><span class="red-area">(If you get an answer that justifies moving on to <?php echo $sale_process_close1->value ?>, skip ahead to closing for a <?php echo $sale_process_close1->value ?>)</span></p>
					...
					<strong class="sub-dev-head-sub2">Technical Pain:</strong>
					  ...
					  <strong class="sub-dev-head-sub2">Business Pain:</strong>
					   ...
					   <br/>
						...
						<p>Which one of those are you most concerned with?</p>
						<?php /*?><p><span class="red-area">(If you get an answer that justifies moving on to <?php echo $sale_process_close1->value ?>, skip ahead to closing for a <?php echo $sale_process_close1->value ?>)</span></p>
						<p><span class="red-area">	(If you do not, move to next section)</span></p></p><?php */?>
        <p style="text-align:center;"><textarea class="sub-dev-cont" name="part-content-<?php echo $partid;?>"></textarea></p>
     <?php
	...
	else if($partid == 5)
	{
	 ?>
     	<h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
        <br/>
        <p>Well, based on what you shared, it might productive for us to talk in more detail.  The reason why is<br/><span class="red-area">(Share any of the below as appropriate as you try to trigger interest)</span><br></p>
	...
	else if($partid == 6)
	{
     ...
     <?php
		...
		$fav_step = str_replace($temp,'',current_url());
		$last_step = true;
	}
