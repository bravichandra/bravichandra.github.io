...
<title>Voicemail Script - Product Focus (Appointment Request)</title>
</head>
<body>
<div id="content">
	...
	<?php } ?>
	<h1 align="center">Voicemail Script &#45; Product Focus (Appointment Request)</h1>
	<p class="topTxt"  >
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr>
			<td>
				...
				<p>
					The purpose of my call is to set up a 15 to 20 minute call with you to discuss 
					your needs around  <?php echo $P_Q1->value; ?>
				</p>
				<p>Please let me know if next Tuesday or Thursday at 10AM or 2PM would work for you. You can reach me at <?php echo $company_meta['your_phone']; ?>.</p>
