...
<title>EMAIL BEFORE CALL EMAILS</title>
</head>
...
<?php $this->load->view('common/logo');?>
	<h1 align="center">Pre&#45;Call Email Thread</h1>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr>
			<td>
				<p><strong>Description:</strong> This first email is the first contact attempt with the prospect and designed to be an introduction that provides a little information to at least make a future cold call more warm if there is not response to the email.</p>
		        ...
		        <span>[Insert Your Company Name]</span> and we help 
		        ...
		        <p>This can often lead to
							...
							<?php $business_data  = $this->home->get_value_pain($product->product_id, 'PB');?>
								<?php if(isset($business_data)):?>
										<?php foreach ($business_data as $business):?>
											<span class="<?php echo (!empty($business->value) ? 'dynamic_value edit_area' : '');?>" id="edit_<?php echo $product->product_id;?>_<?php echo $business->id;?>__bus_pain__tpd"><?php echo $business->value;?></span>,
										<?php endforeach;?>
								<?php endif?>
						<?php endforeach;?>
					<?php endif;?>
			        ...
			        We help to decrease and offset those challenges and that is the purpose for my email.
		        </p>
		...
		<tr><td class="border">&nbsp;</td></tr>
		<tr>
			<td><p><strong>Description:</strong> This second email is designed to follow-up again with the prospect if there was no reply to the first email or if there was no contact made. This email is also designed to be brief and build on what has already been sent over by providing a little more information.</p>
		        ...
		        <p><strong>Subject line:</strong>Following back up</p>
		        ...
		        <p>I sent you information a couple of weeks ago and I just wanted to follow-up with you to see if you had a chance to look at it and if you had any questions or interest. </p>
		        <p>From our research and what has been discussed, it sounds like there is the strong potential to have a productive conversation as we help 
		        ...
		        <span class="<?php echo (!empty($summary['1']->user_data_id) ? 'dynamic_value edit_area' : '');?>" id="edit_<?php echo $user_id;?>_<?php echo (isset($summary['1']->user_data_id) ? $summary['1']->user_data_id : Null);?>__summary__tud"><?php echo (isset($summary['1']->value) ? $summary['1']->value : Null);?></span>. This can often lead to 
...
<span class="dynamic_value edit_area" id="edit_<?php echo $user_id;?>_<?php echo (isset($custome_fields['0']->user_data_id) ? $custome_fields['0']->user_data_id : Null);?>__users__tud"><?php echo (isset($custome_fields['0']->value) ? $custome_fields['0']->value : Null);?></span>.</p>
		...
		<tr>
			<td>
		        ...
		        <p><strong>Subject line:</strong> Checking back</p>
		        ...
		        <p>
		        <div class="red-area">(Choose 1 of below or summarize, these are the benefits you delivered with your name drops)</div>
	        ...
	        <?php if (isset($credibilities)):?>
		       						...
		       						?>
		       						<li>We have helped 
									<span class="dynamic_value edit_area" id="edit_<?php echo $user_id;?>_<?php echo (isset($custome_fields['1']->user_data_id) ? $custome_fields['1']->user_data_id : Null);?>__users__tud"><?php echo (isset($custome_fields['1']->value) ? $custome_fields['1']->value : Null);?></span> to (with) 
	            ...
	            <li>Other key details about us are that we 
		            ...
		            <span class="<?php echo (!empty($interes[2]->value) ? 'dynamic_value edit_area' : '');?>" id="edit_<?php echo $user_id;?>_<?php echo (isset($interes['2']->user_data_id) ? $interes['2']->user_data_id : Null);?>__interest__tud"><?php echo (!empty($interes[2]->value) ? $interes[2]->value : $this->config->item('message'));?></span>.</li></ul>
		   		</p>
