...
<div id="content">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>Great. The purpose of my call is that - <span class="red-area">(Choose one of below)</span> <br/><span class="red-area">(Share any of the below as appropriate as you try to trigger interest)</span><br><br>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>
				<p>Oh, I see. Well, if I could ask you real quick:</p>
				<p><span class="red-area">(Ask 3 to 5 of the below)</span></p>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>Oh, OK. Well, as we talk with other <span class="dynamic_value red-area78"><?php 
						if($campaign_info->campaign_target == '1'){	
								echo $campaign_info->individual;
							}else{
								echo $campaign_info->organization;
...
else if($partid == 2)
{
 ?>
	<h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
	<p>Great. The purpose of my call is that - <span class="red-area">(Choose one of below)</span> <br/><span class="red-area">(Share any of the below as appropriate as you try to trigger interest)</span></p>
...
else if($partid == 4)
{
 ?>
	<h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
    <p>Oh, OK. Well, as we talk with other <span class="dynamic_value red-area78"><?php 
		if($campaign_info->campaign_target == '1'){	
				echo $campaign_info->individual;
			}else{
				echo $campaign_info->organization;
