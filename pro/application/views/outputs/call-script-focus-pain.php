...
<title><?php echo isset($uCustTemplate['template_title'])?$uCustTemplate['template_title']:'Call Script - Pain Focus'; ?></title>
</head>
<body>
...
<div id="content" class="questions">
	...
	<h1 align="center"><?php echo isset($uCustTemplate['template_title'])?$uCustTemplate['template_title']:'Call Script &#45; Pain Intro'; ?></h1>
	<p class="topTxt"  >
	...
	else if($partid == 2 && $partid <= $lastid)
	{
	 	?>
        <h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
		<div class="scroll-bar_sf"><?php $content_id=5;include('custom_content/custom_etemplate_data.php');?></div>
