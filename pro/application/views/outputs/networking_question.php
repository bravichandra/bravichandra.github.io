...
table.output tr td.border {border-top:0px solid #000 !important;}
table.output tr td.border-bottom {border-bottom:0px solid #000 !important;}
...
body, #content, table.output, table.output table {line-height: 25px;}
...
#content p{font-size:16px;}#content ul li{font-size:16px;}
</style>
