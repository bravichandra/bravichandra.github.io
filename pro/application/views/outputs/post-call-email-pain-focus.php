...
?>
<title>Post-Call Email – Pain Focus</title>
<style type="text/css">
...
<div id="content">
	...
	<?php } ?>
	<h1 align="center">Post-Call Email – Pain Focus</h1>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr>
			<td>
		        ...
		        <?php echo $campaign_output_tech_pain[0]->value ?>
		        </p>		        
		        ...
		        <p>
					Reason for the email is that we<?php */?> find that it is very common for 
					<?php 
						if($campaign_info->campaign_target == '1'){	
								 echo $campaign_info->individual;
							}else{ 
                ...
                <p>I am not sure if you are concerned about any of those and that is why I reached out to you. Are you available for a <?php echo $sale_process_close1->value; ?> next Tuesday or Thursday morning where we can <?php echo $sale_process_close2->value; ?>?</p>
