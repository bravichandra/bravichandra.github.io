...
<title><?php echo isset($uCustTemplate['template_title'])?$uCustTemplate['template_title']:'Inbound Call Script'; ?></title>
</head>
<body>
...
else if($partid == 1 && $partid <= $lastid)
{
	?>
    <h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
	<div class="scroll-bar_sf"><?php $content_id=16;include('custom_content/custom_etemplate_data.php');?></div>
...
else if($partid == 2 && $partid <= $lastid)
{
	?>
    <h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
	<div class="scroll-bar_sf"><?php $content_id=17;include('custom_content/custom_etemplate_data.php');?></div>
...
else if($partid == 6 && $partid <= $lastid)
{
	?>
    <h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
	<div class="scroll-bar_sf"><?php $content_id=18;include('custom_content/custom_etemplate_data.php');?></div>
