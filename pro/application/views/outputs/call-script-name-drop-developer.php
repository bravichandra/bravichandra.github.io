...
<?php endif; ?>
<title>Call Script - Name Drop Focus</title>
</head>
...
<div id="content">
	...
	<h1 align="center">Call Script &#45; Name Drop Focus</h1>
	<p class="topTxt"  >
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr style="border-bottom:1px solid #000;">
			...
			<br/> Option B:  <span class="dynamic_value edit_area" id="ccd_<?php echo $sale_process_close3->cam_com_id ?>_<?php echo $campaign_info->campaign_id; ?>"><?php echo (!empty($sale_process_close3->value) ? $sale_process_close3->value : $this->config->item('message'));?></span></td>
		</tr>
		<tr><td colspan="3" class="border">&nbsp;</td></tr>	  
		<tr>
			<td class="td-pad-b"><strong>Introduction to Gatekeeper</strong><br></td>
			<td>&nbsp;</td>
			<td>Hello, I am trying to connect with  <span class=""><?php echo $campaign_info->individual; ?></span>. Can you point me in the right direction?
			</td>
		</tr>
		<tr><td colspan="3" class="border">&nbsp;</td></tr>
		<tr>
		...
		<tr><td colspan="3" class="border">&nbsp;</td></tr>
		<tr>
			<td><strong>Name drop example</strong></td>
			<td>&nbsp;</td>
			<td><p>Purpose for my call is that:</p>
				<ul>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>  Oh, OK. Well, as we talk with other <span class="dynamic_valu "><?php 
						if($campaign_info->campaign_target == '1'){	
								echo $campaign_info->individual;
							}else{
								echo $campaign_info->organization;
					...
					<p><span class="red-area">(Share any of the below pain examples)</span></p>
					...
					<p><span class="red-area">(If you get an answer that justifies moving on to <?php echo $sale_process_close1->value ?>, skip ahead to closing for a <?php echo $sale_process_close1->value ?>)</span></p>
					<p><span class="red-area">(If you do not, move to next section) </p>	
			</td>
		</tr>
		<tr><td colspan="3" class="border">&nbsp;</td></tr>
		<tr>
...
?>
    ...
    <p>Hello  <span class="red-area">[Contact's Name]</span>, this is  <span><?php echo $company_meta['your_name'] ?></span> from  <?php echo  $company_info->company_name ; ?> , have I caught you in the middle of anything?</p>
    <p><span class="red-area">(If not available respond with below)</span><p>
    <p>Oh, I understand. I can be very brief or I can call you back at another time, which do you prefer?</p>
    <span class="red-area"> -or- </span>
    <p>Oh, I understand. When would be the best time for me to call you back?</p>
...
?>
    ...
    <h3 class="sub-dev-head-sub1">Disqualify Statement</h3>
    <p>I actually don't know if you need what our services provide so I just had a question or two. </p>
    <p><span class="red-area"> -or-</span></p>   
    <p> I actually don't know if you are a good fit for what we provide so I just had a question or two.</p>
    <p><span class="red-area">-or-</span></p> 
    <p>I don't know if you are the right person to speak with but I have just a couple of questions.</p>
...
?>
	<h1 class="sub-dev-head"><?php echo $parts[$partid]['title'];?></h1>
    <!-- Start -->
    <p>Oh, OK. Well, as we talk with other <span class="dynamic_valu "><?php 
		if($campaign_info->campaign_target == '1'){	
				echo $campaign_info->individual;
			}else{
				echo $campaign_info->organization;
		}
	?></span>, we have noticed that they often express challenges with <span class="red-area">(or concerns around) </span> : </p>
