...
?>
<title>Post-Call Email – Value Focus</title>
</head>
<body>
<div id="content">
	...
	<?php } ?>
	<h1 align="center">Post-Call Email – Value Focus</h1>
	<p class="topTxt"  >
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="output">
		...
		<tr>
			<td>
                ...
                <p>I don’t know if you are interested in any of those and that is why I reached out to you. Are you available for a <?php echo $sale_process_close1->value; ?> next Tuesday or Thursday morning where we can <?php echo $sale_process_close2->value; ?>?</p>
		        <p>Best Regards,</p>
		        <p>
