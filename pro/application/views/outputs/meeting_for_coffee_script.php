...
<?php endif; ?>
<title><?php echo isset($uCustTemplate['template_title'])?$uCustTemplate['template_title']:'Meet for Coffee Script'; ?></title>
</head>
...
<div id="content">
	...
	<h1 align="center"><?php echo isset($uCustTemplate['template_title'])?$uCustTemplate['template_title']:'Meet for Coffee Script'; ?></h1>
	<p class="topTxt"  >
