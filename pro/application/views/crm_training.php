					...
					<div class="fluid">
						<div class="grid6" style="width:initial;">
							<div class="widget" style="padding-right:20px;">
								<h1 style="margin-left:10px; margin-bottom:10px;" class="pt10">CRM Training</h1>
                                <iframe width="560" height="315" src="https://www.youtube.com/embed/videoseries?list=PLoUVJsDQgZIKZ-TA8qGrWDHccKEiQNHvP" frameborder="0" allowfullscreen></iframe>							
							</div>
						</div>						
					</div>
				<?php // endif; ?>							
